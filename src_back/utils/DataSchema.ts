...
const UserDataSchema = {
	...
	properties: {
					...
					actions: {
						...
						items: {
							...
							properties: {
								...
								show: {
									anyOf: [{ type: "string", maxLength: 20 }, { type: "boolean" }],
								},
								delay: {
									anyOf: [
										{ type: "string", maxLength: 50 },
								...
								rewardAction: {
									...
									properties: {
										...
										action: {
											enum: ["toggle", "edit", "create", "delete", "refund"],
										},
										rewardEdit: {
											type: "object",
											additionalProperties: false,
		...
		"p:autoTranslateFirstLang": {
			//Delete after some time, updated to "autoTranslateLang"
			type: "array",
			minItems: 0,
			maxItems: 1,
			items: { type: "string", maxLength: 3 },
		...
		"p:autoTranslateFirstSpoken": {
			//Delete after some time, updated to "autoTranslateSpoken"
			type: "array",
			minItems: 0,
			maxItems: 60,
			items: { type: "string", maxLength: 3 },
		...
		rafflesRunning: {
			...
			items: {
				...
				properties: {
					...
					tip_streamlabsCharity_minAmount: {
						type: "number",
						minimum: 0,
						maximum: 999999,
					},
					...
					tip_kofi_ponderate: { type: "integer", minimum: 0, maximum: 999999 },
					tip_streamlabs_ponderate: { type: "integer", minimum: 0, maximum: 999999 },
					tip_streamlabsCharity_ponderate: {
						type: "integer",
						minimum: 0,
						maximum: 999999,
					},
