...
export default class Config {
	...
	public static get lifetimeDonorThreshold(): number {
		return 89;
	}
	public static get donorsList(): string {
		return this.DONORS_DATA_FOLDER + "donors.json";
	}
	public static get earlyDonors(): string {
		return this.DONORS_DATA_FOLDER + "earlyDonors.json";
	}
	public static get giftedPremium(): string {
		return this.DONORS_DATA_FOLDER + "giftedPremiums.json";
	}
	public static get donorsAnonStates(): string {
		return this.DONORS_DATA_FOLDER + "public_states.json";
	}
	...
	public static get patreonToken(): string {
		return this.PATREON_DATA_FOLDER + "patreonToken.json";
	}
	/**
	 * Get active patreon member list
	 */
	public static get patreonMembers(): string {
		return this.PATREON_DATA_FOLDER + "patreonMembers.json";
	}
	/**
	 * Links a twitch user ID to a Patreon token
	 */
	public static get twitch2PatreonToken(): string {
		return this.PATREON_DATA_FOLDER + "twitch2PatreonToken.json";
	}
	/**
	 * Links a twitch user ID to a Patreon member ID
	 */
	public static get twitch2Patreon(): string {
		return this.PATREON_DATA_FOLDER + "patreon2Twitch.json";
	}
	/**
	 * Links a patreon user ID to their webhook secret
	 */
	public static get patreonUid2WebhookSecret(): string {
		return this.PATREON_DATA_FOLDER + "uid2webhookSecret.json";
	}
	/**
	 * Links a twitch user ID to a discord guildID
	 */
	public static get discord2Twitch(): string {
		return this.DISCORD_DATA_FOLDER + "discord2Twitch.json";
	}
