...
| [`mention`](#mention)           | Text            | Prefixes the value with a "@" so it becomes a mention.                                                     |
...
Prefixes the value with a "@" so it becomes a mention. Values already starting with a "@" aren't doubled, and empty values are left alone.
