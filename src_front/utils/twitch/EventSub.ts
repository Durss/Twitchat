...
export default class EventSub {
	...
	*******************/
	...
	public adBreakEvent(topic:TwitchEventSubDataTypes.SubscriptionStringTypes, event:TwitchEventSubDataTypes.AdBreakEvent):void {
		...
		infos.currentAdStart_at = new Date(typeof event.started_at == "number"? event.started_at * 1000 : event.started_at).getTime(),//Thank you twitch for writing a completely wrong documentation...don't know if they'll change the doc or the service, so i handle both cases
