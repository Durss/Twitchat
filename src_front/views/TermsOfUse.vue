<template>
	<div class="termsofuse">
		...
		<div class="content card-item">
			...
			<p>
				We are François Dursus ("Company," "we," "us," "our"), a company registered in
				France at 115 rue de meaux, PARIS 75019.
			</p>
			<p>
				We operate the website
				<a href="https://twitchat.fr" target="_blank">https://twitchat.fr</a> (the "Site"),
			...
			<p>
				...
				personally or on behalf of an entity ("you"), and François Dursus, concerning your
			...
			<p>
				...
				{{ $config.CONTACT_MAIL }}. If we ever grant you the permission to post, reproduce,
				or publicly display any part of our Services or Content, you must identify us as the
			...
			<p>
				...
				on and through your account on the Services. Please note that if a Third-Party
				...
				You can deactivate the connection between the Services and your Third-Party Account
			...
			<p>
				We want to inform you that Twitchat utilizes YouTube API Services to provide
				enhanced features and functionalities. This integration allows you to seamlessly
				access and interact with YouTube content directly through Twitchat.
			</p>
			<p>
				Please note that your use of Twitchat is subject to both our terms of service and
				<a href="https://www.youtube.com/t/terms" target="_blank"
					>Youtube Terms of Services</a
				>. It's important to familiarize yourself with these terms to ensure compliance and
			...
			<p>
				...
				twitchat/fr/privacypolicy. By using the Services, you agree to be bound by our
				Privacy Policy, which is incorporated into these Legal Terms. Please be advised the
				Services are hosted in France. If you access the Services from any other region of
				the world with laws or other requirements governing personal data collection, use,
				or disclosure that differ from applicable laws in France, then through your
				continued use of the Services, you are transferring your data to France, and you
				expressly consent to have your data transferred to and processed in France.
			</p>
			...
			<p>
				These Legal Terms are governed by and interpreted following the laws of France, and
				...
				provisions of the law in your country to residence. François Dursus and yourself
				both agree to submit to the non-exclusive jurisdiction of the courts of paris, which
				means that you may make a claim to defend your consumer protection rights in regards
				to these Legal Terms in France, or in the EU country in which you reside.
			</p>
			...
			<p>
				...
				this clause constitutes acceptance. The seat of arbitration shall be Paris, France.
				The language of the proceedings shall be French. Applicable rules of substantive law
			...
			<p>
				...
				THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY,
				BY YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR
				$50.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON
			...
			<p>
				...
				<a href="https://termly.io/products/terms-and-conditions-generator/" target="_blank"
