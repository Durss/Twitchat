...
class GoXLRDebug extends Vue {
	...
	public param_genderStyle: TwitchatDataTypes.ParameterData<"Narrow" | "Medium" | "Wide"> = {
		type: "list",
	...
	public param_genderAmount: TwitchatDataTypes.ParameterData<number> = {
		type: "slider",
		value: 0,
		min: -12,
		max: 12,
	...
	public param_echoStyle: TwitchatDataTypes.ParameterData<
		"Quarter" | "Eighth" | "MultiTap" | "Triplet" | "PingPong" | "ClassicSlap"
	> = {
		type: "list",
		listValues: ["Quarter", "Eighth", "MultiTap", "Triplet", "PingPong", "ClassicSlap"].map(
			(v) => {
				return { label: v, value: v };
			},
		),
	...
	public param_echoAmount: TwitchatDataTypes.ParameterData<number> = {
		type: "slider",
		value: 0,
		min: 0,
		max: 100,
