<template>
	<div :class="classes">
		...
		<OverlayMusicPlayer
			v-if="overlay == 'music' || overlay == 'unified'"
			:embed="overlay == 'unified'"
...
const OverlayHeatDebug = defineAsyncComponent({
	loader: () => import("../components/overlays/OverlayHeatDebug.vue"),
});
const OverlayEndingCredits = defineAsyncComponent({
	loader: () => import("../components/overlays/OverlayEndingCredits.vue"),
});
const OverlayMusicPlayer = defineAsyncComponent({
	loader: () => import("../components/overlays/OverlayMusicPlayer.vue"),
});
const OverlaysRaffleWheel = defineAsyncComponent({
	loader: () => import("../components/overlays/OverlaysRaffleWheel.vue"),
});
const OverlayTimer = defineAsyncComponent({
	loader: () => import("../components/overlays/OverlayTimer.vue"),
});
const OverlayChatHighlight = defineAsyncComponent({
	loader: () => import("../components/overlays/OverlayChatHighlight.vue"),
});
const OverlayCounter = defineAsyncComponent({
	loader: () => import("../components/overlays/OverlayCounter.vue"),
});
const OverlayUlule = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayUlule.vue"),
});
const OverlayAdBreak = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayAdBreak.vue"),
});
const OverlayDistort = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayDistort.vue"),
});
const OverlayPredictions = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayPredictions.vue"),
});
const OverlayPoll = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayPoll.vue"),
});
const OverlayBingoGrid = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayBingoGrid.vue"),
});
const OverlayDonationGoals = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayDonationGoals.vue"),
});
const OverlayChatPoll = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayChatPoll.vue"),
});
const OverlayAnimatedText = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayAnimatedText.vue"),
});
const OverlayCustomTrain = defineAsyncComponent({
	loader: () => import("@/components/overlays/OverlayCustomTrain.vue"),
});
const OverlayQuiz = defineAsyncComponent({
