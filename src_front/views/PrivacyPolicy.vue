<template>
	<div class="privacypolicy">
		...
		<div class="content card-item">
			...
			<p>
				This privacy notice for <strong>François Dursus</strong> ("<strong>we</strong>,"
			...
			<ul>
				<li>
					Visit our website at twitchat.fr, or any website of ours that links to this
					privacy notice
				</li>
				<li>
			...
			<p>
				...
				concerns, please contact us at {{ $config.CONTACT_MAIL }}.
			</p>
			...
			<p>
				<strong
					...
					point or by using our <a href="#toc">table of contents</a> below to find the
					section you are looking for.</strong
				>
			</p>
			...
			<p>
				<strong>Do we receive any information from third parties?</strong> We receive
				information you specifically grant us to access. This can include Twitch data like
				your login, your followers, your followings or your subscribers. If you connect with
				Yoube services, this also includes your Youtube profile name and your Youtube live
				broadcast sessions.
			</p>
			...
			<p>
				...
				<a href="#privacyrights" target="_blank">your privacy rights</a>.
			</p>

			<p>
				<strong>How do you exercise your rights?</strong> The easiest way to exercise your
				rights is by
				<a @click="openDataMnagerForm()" target="_blank">opening data management form</a>.
			</p>
			...
			<ul class="index">
				...
				<li>
					<a href="#legalbases"
						>WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a
					>
				</li>
				<li>
					<a href="#whoshare"
			...
			<p>
				...
				register with us using your existing social media account details, like Twitch,
				Youtube, or other social media account. If you choose to register in this way, we
				will collect the information described in the section called "<a
					href="#sociallogins"
			...
			<p>
				By using Twitchat, you acknowledge and agree that our service may store, access, or
				collect information directly or indirectly on or from users' devices. This includes,
				but is not limited to, access tokens, cookies or similar technologies on users'
				devices or browsers.
			</p>

			<p><strong>Third-Party Involvement:</strong></p>
			<p>
				In some instances, third parties may also be involved in the storage, access, or
				collection of information through Twitchat. These third parties are subject to their
			...
			By using [Your API Client Name], you acknowledge and agree that our service may store,
			access, or collect information directly or indirectly on or from users' devices. This
			includes, but is not limited to, the placement, access, or recognition of cookies or
			similar technologies on users' devices or browsers.
			...
			<p>
				...
				social media account details (like your Twitch logins). Where you choose to do this,
				...
				provider concerned, but will often include your nickname, real name (with Youtube),
				your followers, and profile picture, as well as other information you choose to make
			...
			<p>
				<strong class="underline" id="withdrawconsent">Withdrawing your consent:</strong> If
				we are relying on your consent to process your personal information, which may be
			...
			<p>
				Twitchat utilizes YouTube API Services to enhance and provide specific
				functionalities within our platform. By using Twitchat, you acknowledge and agree to
				the collection and processing of data through YouTube API Services as outlined in
				<a href="https://policies.google.com/privacy" target="_blank"
					>Google Privacy Policy</a
				>.
			</p>
			<p>
				If Twitchat accesses or uses Authorized Data, users have the ability to revoke the
				API Client's access to their data through the
				<a href="https://security.google.com/settings/security/permissions" target="_blank"
					>Google security settings page</a
				>. In addition to Twitchat's normal procedure for deleting stored data, users can
				take the following steps to manage access:
			</p>
			<ul>
				<li>
				...
				<li>
					Revoke access by selecting Twitchat and following the provided instructions.
				</li>
			</ul>

			<p>
				Twitchat use and transfer to any other app of information received from Google APIs
				will adhere to
				<a
			...
			<p>
				We want to make it clear that none of the data obtained from third-party APIs will
				be shared with any other third party. The information retrieved from these services
				is solely used to provide and improve the functionality of our web app.
			</p>
			...
			<table>
				...
				<tr>
					...
					<td class="center"><Icon name="cross" theme="alert" /></td>
				</tr>
				<tr>
					<td>
			...
			<p>
				You may contact us by email at {{ $config.CONTACT_MAIL }} , or by referring to the
			...
			<p>
				...
				email) that you have previously provided to us. We may also use other verification
			...
			<p>
				...
				{{ $config.CONTACT_MAIL }} , or by referring to the contact details at the bottom of
			...
			<p>
				<strong>In Short:</strong> Yes, if you are a resident of Virginia, you may be
				granted specific rights regarding access to and use of your personal information.
			</p>
			...
			<p>
				...
				you interact with us and our Services. To find out more, please visit the following
				links:
			</p>
			<ul>
			...
			<p>
				We have not sold any personal data to third parties for business or commercial
				purposes. We will not sell personal data in the future belonging to website
			...
			<p>
				...
				<a @click="openDataMnagerForm()" target="_blank">open data management form</a>.
			</p>
			<p>
				This privacy policy was created using Termly's
				<a href="https://termly.io/products/privacy-policy-generator/" target="_blank"
		...
		<div class="dataManager modal" v-if="showDataManager">
			...
			<div class="holder">
				...
				<div class="content" v-else>
					<p>
						Twitchat only keeps your parameters on its server. You can download or
						delete them.
					</p>
					<div class="ctas">
						<Button @click="downloadData()" icon="download" :loading="downloadingData"
							>Download your personnal data</Button
						>
						<Button
							...
							icon="trash"
							alert
							>Delete your personnal data</Button
						>
						<p
							v-if="showDeleteInput && !deleteDone && !deletingData"
							class="instructions"
						>
							Please write "<strong>DELETE MY DATA</strong>" below and submit
						</p>
						<form
							v-if="showDeleteInput && !deleteDone && !deletingData"
						...
						>
							<input
								type="text"
								placeholder="write DELETE MY DATA..."
								v-model="confirmation"
							/>
							<Button
								type="submit"
								alert
								:disabled="confirmation.trim().toLowerCase() != 'delete my data'"
								>DELETE</Button
							>
						</form>
						<Icon v-if="deletingData" class="loader" name="loader" />
						<div v-if="deleteDone" class="card-item primary">
							Your data have been successfully deleted
						</div>
					</div>
				</div>
			</div>
