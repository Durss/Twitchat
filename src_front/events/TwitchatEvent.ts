...
export default class TwitchatEvent extends Event {
	...
	public static CHAT_FEED_SELECT_ACTION_TIMEOUT_1:TwitchatActionType = "CHAT_FEED_SELECT_ACTION_TIMEOUT_1";
	public static CHAT_FEED_SELECT_ACTION_TIMEOUT_2:TwitchatActionType = "CHAT_FEED_SELECT_ACTION_TIMEOUT_2";
...
export const TwitchatActionTypeList = [
	...
	"CHAT_FEED_SELECT_ACTION_TIMEOUT_1",
	"CHAT_FEED_SELECT_ACTION_TIMEOUT_2",
	"POLL_TOGGLE",
	"POLL_CREATE",
	"PREDICTION_TOGGLE",
	"PREDICTION_CREATE",
