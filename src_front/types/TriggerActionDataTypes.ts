...
export const TriggerTypes = {
	...
	YOUTUBE_JEWELS: "189",
	RAFFLE_JOIN: "190",
	STREAMERSONGLIST_QUEUE_ADD: "191",
	STREAMERSONGLIST_QUEUE_REMOVE: "192",
	STREAMERSONGLIST_QUEUE_UPDATE: "193",
...
/**
 * Incremented every time the event placeholders change.
 * Watch it to refresh anything built from TriggerEventPlaceholders().
 * This avoids putting the whole trigger list (almost 8K entrie today)
 * as reactive only to watch for its changes
 */
export const placeholderCacheVersion = ref(0);
...
export function TriggerTypesDefinitionList(): TriggerTypeDefinition[] {
	...
	eventsCache = [
		...
		},
		{
			category: TriggerEventTypeCategories.USER,
			icon: "modiversary",
			labelKey: "triggers.events.MODIVERSARY.label",
			value: TriggerTypes.MODIVERSARY,
			descriptionKey: "triggers.events.MODIVERSARY.description",
			testMessageType: TwitchatDataTypes.TwitchatMessageType.USER_MODIVERSARY,
		},
		{
			category: TriggerEventTypeCategories.USER,
			icon: "online",
