...
export function TriggerEvents():TriggerEventTypes[] {
	...
	return [
		...
		{category:TriggerEventTypeCategories.USER, icon:"shoutout", label:t("triggers.events.SHOUTOUT_OUT.label"), value:TriggerTypes.SHOUTOUT_OUT, description:t("triggers.events.SHOUTOUT_OUT.description"), testMessageType:TwitchatDataTypes.TwitchatMessageType.SHOUTOUT},
		{category:TriggerEventTypeCategories.USER, icon:"shoutout", label:t("triggers.events.SHOUTOUT_IN.label"), value:TriggerTypes.SHOUTOUT_IN, description:t("triggers.events.SHOUTOUT_IN.description"), testMessageType:TwitchatDataTypes.TwitchatMessageType.SHOUTOUT},
