...
export function TriggerEventPlaceholders(key:TriggerTypesValue):ITriggerPlaceholder<any>[] {
	...
	map[TriggerTypes.CHAT_COMMAND] = [
		...
		{tag:"MESSAGE_PARSED", descKey:'triggers.placeholders.message_parsed', pointer:"message_chunks", numberParsable:false, isUserID:false} as ITriggerPlaceholder<SafeMessage>,
