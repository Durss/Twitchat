...
export function TriggerEvents():TriggerEventTypes[] {
	...
	eventsCache = [
		...
		{category:TriggerEventTypeCategories.MOD, icon:"timeout", label:t("triggers.events.TIMEOUT.label"), value:TriggerTypes.TIMEOUT, description:t("triggers.events.TIMEOUT.description"), testMessageType:TwitchatDataTypes.TwitchatMessageType.BAN},
		{category:TriggerEventTypeCategories.MOD, icon:"ban", label:t("triggers.events.BAN.label"), value:TriggerTypes.BAN, description:t("triggers.events.BAN.description"), testMessageType:TwitchatDataTypes.TwitchatMessageType.BAN},
		{category:TriggerEventTypeCategories.MOD, icon:"unban", label:t("triggers.events.UNBAN.label"), value:TriggerTypes.UNBAN, description:t("triggers.events.UNBAN.description"), testMessageType:TwitchatDataTypes.TwitchatMessageType.UNBAN},
