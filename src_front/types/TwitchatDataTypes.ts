...
export namespace TwitchatDataTypes {
	...
	export interface ParameterData<T, U = unknown, V = unknown, W = any> {
		 ...
		 * Parameter type
		 */
		type:"boolean"|"number"|"string"|"slider"|"password"|"list"|"browse"|"editablelist"|"color"|"date"|"datetime"|"time"|"imagelist"|"duration"|"custom"|"font";
		/**
		 * Parameter value
		 */
		value:T;
	...
	export const MessageListFilterTypes:{type:AllowFilterTypes, labelKey:string, icon:string, scopes:TwitchScopesString[], newFlag:number}[] = [
		...
		{type:TwitchatMessageType.NOTICE,								labelKey:"chat.filters.message_types.notice",								icon:"mod",				scopes:[TwitchScopes.BLOCKED_TERMS, TwitchScopes.CHAT_WARNING, TwitchScopes.SET_ROOM_SETTINGS, TwitchScopes.UNBAN_REQUESTS, TwitchScopes.EDIT_BANNED, TwitchScopes.DELETE_MESSAGES, TwitchScopes.EDIT_MODS, TwitchScopes.EDIT_VIPS],	newFlag:0},
