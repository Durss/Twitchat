...
export default class DataStoreCommon {
	 ...
	 */
	public static async migrateData(_data: any): Promise<any> {
	 ...
	 */
	public static async loadRemoteData(_importToLS: boolean = true): Promise<boolean> {
		return true;
	}
	...
	public static async loadFromJSON(json: any): Promise<void> {
		...
		let automod: TwitchatDataTypes.AutomodParamsData & JsonObject = JSON.parse(
			this.get(DataStoreCommon.AUTOMOD_PARAMS),
		);
	 ...
	 * @returns
	 */
	public static async set(key: string, value: any, save = true): Promise<void> {
