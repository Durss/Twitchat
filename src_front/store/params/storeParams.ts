...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		features: {
			...
			raidHighlightUserDuration:	{save:true, type:"number", value:5, labelKey:"params.raidHighlightUserDuration", id:222, icon:"timer_purple.svg", parent:209, min:1, max:60*24*30},
			...
			raffleHighlightUserDuration:{save:true, type:"number", value:5, labelKey:"params.raffleHighlightUserDuration", id:223, icon:"timer_purple.svg", parent:218, min:1, max:60*24*30},
