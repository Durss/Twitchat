...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		features: {
			...
			manyRepliesAlert:	 		{type:"boolean", value:true, labelKey:"params.manyRepliesAlert", id:236, icon:"reply_many", storage:{vnew:{date:Config.instance.NEW_FLAGS_DATE_V16_12, id:'manyRepliesAlert'}}},
			manyRepliesAlertThreshold:	{type:"number", value:7, labelKey:"params.manyRepliesAlertThreshold", id:237, parent:236, min:2, max:20},
		...
		appearance: {
			...
			hideAnswersTo: 				{type:"boolean", value:false, labelKey:"params.hideAnswersTo", id:52, icon:"user", example:"hideAnswersTo.png", storage:{vnew:{date:1771444874612, id:'params_hideAnswersTo'}}},
			fadeAnswers: 				{type:"boolean", value:false, labelKey:"params.fadeAnswers", icon:"reply", id:54, storage:{vnew:{date:1771444874612, id:'params_fadeAnswers'}}},
			...
			helloBadge: 				{type:"boolean", value:true, labelKey:"params.helloBadge", id:53, icon:"hand", example:"helloBadge.png", storage:{vnew:{date:1771444874612, id:'params_helloBadge'}}},
			firstUserBadge: 			{type:"boolean", value:true, labelKey:"params.firstUserBadge", id:45, icon:"firstTime", example:"firstUserBadge.png"},
