...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		features: {
			...
			showModTools: 				{save:true, type:"toggle", value:true, labelKey:"params.showModTools", id:206, icon:"ban_purple.svg", twitch_scope:TwitchScopes.MODERATE},
			...
			offlineEmoteOnly:			{save:true, type:"toggle", value:false, labelKey:"params.offlineEmoteOnly", id:214, icon:"emote_purple.svg", twitch_scope:TwitchScopes.SET_ROOM_SETTINGS},
			stopStreamOnRaid:			{save:true, type:"toggle", value:false, labelKey:"params.stopStreamOnRaid", id:212, icon:"obs_purple.svg"},
