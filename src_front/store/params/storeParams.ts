...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		appearance: {
			...
			highlightPartners_color:	{save:true, type:"color", value:"#ffee52", labelKey:"params.highlightColor", id:32, parent:26},
			highlightMentions: 			{save:true, type:"boolean", value:true, labelKey:"params.highlightMentions", id:1, icon:"broadcaster.svg"},
			highlightMentions_color:	{save:true, type:"color", value:"#ff0000", labelKey:"params.highlightColor", id:33, parent:1},
