...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		features: {
			...
			userHistoryEnabled: 		{save:true, type:"boolean", value:true, labelKey:"params.userHistoryEnabled", id:203, icon:"conversation", example:"userHistory.gif"},
			...
			raffleHighlightUser:		{save:true, type:"boolean", value:true, labelKey:"params.raffleHighlightUser", id:218, icon:"ticket", example:"raidHighlightUser.png"},
