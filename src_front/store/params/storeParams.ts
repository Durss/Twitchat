...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		features: {
			...
			mergeConsecutive_maxSize:	{save:true, type:"number", value:50, labelKey:"params.mergeConsecutive_maxSize", id:226, parent:225, min:1, max:500},
			...
			mergeConsecutive_minDuration:{save:true, type:"number", value:10, labelKey:"params.mergeConsecutive_minDuration", id:228, parent:225, min:0, max:3600},
