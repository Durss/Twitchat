...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		features: {
			...
			liveMessages:				{save:true, type:"toggle", value:true, labelKey:"params.liveMessages", id:219, icon:"whispers_purple.svg", example:"liveMessages.png"},
		...
		appearance: {
			...
			highlight1stToday: 			{save:true, type:"toggle", value:true, labelKey:"params.highlight1stToday", id:28, icon:"hand_purple.svg"},
