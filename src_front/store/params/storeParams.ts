...
export const storeParams = defineStore("params", {
		...
		({
			...
			features: {
				...
				firstMessage: {
					type: "boolean",
					value: true,
					labelKey: "params.firstMessage",
					id: 201,
					icon: "hand",
					example: "greetThem.png",
				},
				saveHistory: {
					type: "boolean",
					value: true,
				...
				antiHateRaidDeleteMessage: {
					type: "boolean",
					value: false,
					labelKey: "params.antiHateRaidDeleteMessage",
					id: 234,
					parent: 232,
					icon: "trash",
					storage: {
				...
				antiHateRaidEmergency: {
					type: "boolean",
					value: false,
					labelKey: "params.antiHateRaidEmergency",
					id: 235,
					parent: 232,
					icon: "emergency",
					storage: {
				...
				autoTranslateFirst: {
					type: "boolean",
					value: true,
					labelKey: "params.autoTranslate_first",
					id: 238,
					parent: 229,
					icon: "firstTime",
				},
				autoTranslateLang: {
					...
					multiple: true,
					max: 1,
					listValues: Object.values(TranslatableLanguagesMap).map((v) => {
						return { value: v.iso1, flag: v.flag, label: v.name };
					}),
					labelKey: "params.autoTranslate_lang",
					id: 231,
					parent: 229,
					icon: "voice",
				},
				autoTranslateSpoken: {
					...
					labelKey: "params.autoTranslate_spoken",
					id: 230,
					parent: 229,
					icon: "voice",
				},
				...
				manyRepliesAlertThreshold: {
					type: "number",
					value: 7,
					labelKey: "params.manyRepliesAlertThreshold",
					id: 237,
					parent: 236,
					min: 2,
					max: 20,
				...
				mergeConsecutive: {
					type: "boolean",
					value: true,
					labelKey: "params.mergeConsecutive",
					id: 225,
					icon: "merge",
				...
				mergeConsecutive_maxSize: {
					type: "number",
					value: 100,
					labelKey: "params.mergeConsecutive_maxSize",
					id: 226,
					parent: 225,
					min: 1,
					max: 500,
				...
				mergeConsecutive_maxSizeTotal: {
					type: "number",
					value: 1000,
					labelKey: "params.mergeConsecutive_maxSizeTotal",
					id: 227,
					parent: 225,
					min: 10,
					max: 2000,
				...
				mergeConsecutive_minDuration: {
					...
					value: 10,
					max: 30 * 60,
					labelKey: "params.mergeConsecutive_minDuration",
					id: 228,
					parent: 225,
					min: 0,
				},
				groupIdenticalMessage: {
					type: "boolean",
					value: true,
					labelKey: "params.groupIdenticalMessage",
					id: 208,
					icon: "increment",
					example: "groupIdenticalMessage.gif",
				},
				markAsRead: {
					type: "boolean",
					value: true,
					labelKey: "params.markAsRead",
					id: 204,
					icon: "read",
				},
				conversationsEnabled: {
					type: "boolean",
					value: true,
					labelKey: "params.conversationsEnabled",
					id: 202,
					icon: "conversation",
					example: "conversation.gif",
				},
				userHistoryEnabled: {
					type: "boolean",
					value: true,
					labelKey: "params.userHistoryEnabled",
					id: 203,
					icon: "conversation",
				},
				lockAutoScroll: {
					type: "boolean",
					value: false,
					labelKey: "params.lockAutoScroll",
					id: 205,
					icon: "pause",
				},
				liveMessages: {
					type: "boolean",
					value: true,
					labelKey: "params.liveMessages",
					id: 219,
					icon: "whispers",
					example: "liveMessages.png",
				},
				liveAlerts: {
					type: "boolean",
					value: false,
					labelKey: "params.liveAlerts",
					id: 220,
					icon: "online",
					twitch_scopes: [TwitchScopes.LIST_FOLLOWINGS],
				},
				autoRemod: {
					type: "boolean",
					value: false,
					labelKey: "params.autoRemod",
					id: 222,
					icon: "mod",
				...
				raffleHighlightUser: {
					type: "boolean",
					value: true,
					labelKey: "params.raffleHighlightUser",
					id: 218,
					icon: "ticket",
					example: "trackUser.png",
				},
				raffleHighlightUserDuration: {
					type: "number",
					value: 5,
					labelKey: "params.raffleHighlightUserDuration",
					id: 223,
					icon: "timer",
					parent: 218,
					min: 1,
				...
				offlineEmoteOnly: {
					type: "boolean",
					value: false,
					labelKey: "params.offlineEmoteOnly",
					id: 214,
					icon: "emote",
				...
				stopStreamOnRaid: {
					type: "boolean",
					value: false,
					labelKey: "params.stopStreamOnRaid",
					id: 212,
					icon: "obs",
				...
				showUserPronouns: {
					type: "boolean",
					value: false,
					labelKey: "params.showUserPronouns",
					id: 213,
					icon: "user",
				},
				chatShoutout: {
			...
			appearance: {
				splitViewVertical: {
					type: "boolean",
					value: false,
					labelKey: "params.splitViewVertical",
					id: 21,
					icon: "layout",
					example: "verticalLayout.png",
				},
				censorDeletedMessages: {
					type: "boolean",
					value: true,
					labelKey: "params.censorDeletedMessages",
					id: 25,
					icon: "hide",
				},
				multiChatAvatar: {
					type: "boolean",
					value: false,
					labelKey: "params.multiChatAvatar",
					id: 47,
					icon: "avatar",
				...
				multiChatColor: {
					type: "boolean",
					value: false,
					labelKey: "params.multiChatColor",
					id: 51,
					icon: "color",
					parent: 47,
				},
				...
				highlightusernames: {
					type: "boolean",
					value: true,
					labelKey: "params.highlightusernames",
					id: 44,
					icon: "user",
				...
				highlightMods_color: {
					type: "color",
					value: "#00a865",
					labelKey: "params.highlightColor",
					id: 29,
					parent: 9,
				},
				highlightVips: {
				...
				highlightPartners: {
					type: "boolean",
					value: false,
					labelKey: "params.highlightPartners",
					id: 26,
					icon: "partner",
				},
				...
				highlightMentions: {
					type: "boolean",
					value: true,
					labelKey: "params.highlightMentions",
					id: 1,
					icon: "broadcaster",
				},
				...
				highlightMentions_custom: {
					type: "editablelist",
					value: [],
					labelKey: "params.highlightCustom",
					id: 48,
					parent: 1,
					placeholderKey: "params.highlightCustom_placeholder",
					maxLength: 20,
					max: 10,
				},
				raidHighlightUser: {
					type: "boolean",
					value: true,
					labelKey: "params.raidHighlightUser",
					id: 34,
					icon: "raid",
				},
				...
				raidHighlightUserDuration: {
					type: "number",
					value: 5,
					labelKey: "params.raidHighlightUserDuration",
					id: 35,
					icon: "timer",
					parent: 34,
					min: 1,
				...
				raidHighlightUserTrack: {
					type: "boolean",
					value: false,
					labelKey: "params.raidHighlightUserTrack",
					id: 42,
					icon: "magnet",
					parent: 34,
					example: "trackUser.png",
				...
				highlight1stEver: {
					type: "boolean",
					value: true,
					labelKey: "params.highlight1stEver",
					id: 37,
					icon: "firstTime",
				},
				...
				highlight1stToday: {
					type: "boolean",
					value: false,
					labelKey: "params.highlight1stToday",
					id: 28,
					icon: "hand",
				},
				...
				highlightNonFollowers: {
					type: "boolean",
					value: false,
					labelKey: "params.highlightNonFollowers",
					id: 16,
					icon: "unfollow",
					example: "nofollow.png",
					twitch_scopes: [TwitchScopes.LIST_FOLLOWERS],
				},
				helloBadge: {
					type: "boolean",
					value: true,
					labelKey: "params.helloBadge",
					id: 53,
					icon: "hand",
				...
				firstUserBadge: {
					type: "boolean",
					value: true,
					labelKey: "params.firstUserBadge",
					id: 45,
					icon: "firstTime",
					example: "firstUserBadge.png",
				},
				recentAccountUserBadge: {
					type: "boolean",
					value: false,
					labelKey: "params.recentAccountUserBadge",
					id: 46,
					icon: "date",
				...
				translateNames: {
					type: "boolean",
					value: true,
					labelKey: "params.translateNames",
					id: 22,
					icon: "translate",
					example: "translate_username.png",
				},
				showRewardsInfos: {
					type: "boolean",
					value: false,
					labelKey: "params.showRewardsInfos",
					id: 23,
					icon: "channelPoints",
					example: "rewardDetails.png",
				},
				showViewersCount: {
					type: "boolean",
					value: true,
					labelKey: "params.showViewersCount",
					id: 17,
					icon: "user",
				},
				showRaidViewersCount: {
					type: "boolean",
					value: true,
					labelKey: "params.showRaidViewersCount",
					id: 40,
					icon: "raid",
					example: "raid_count.png",
				},
				showRaidStreamInfo: {
					type: "boolean",
					value: true,
					labelKey: "params.showRaidStreamInfo",
					id: 43,
					icon: "raid",
				...
				alternateMessageBackground: {
					type: "boolean",
					value: true,
					labelKey: "params.alternateMessageBackground",
					id: 41,
					icon: "whispers",
				},
				showEmotes: {
				...
				minimalistBadges: {
					type: "boolean",
					value: false,
					labelKey: "params.minimalistBadges",
					id: 5,
					parent: 4,
					example: "minibadges.png",
				},
				displayTime: {
					type: "boolean",
					value: false,
					labelKey: "params.displayTime",
					id: 6,
					icon: "timeout",
				},
				displayTimeRelative: {
					type: "boolean",
					value: false,
					labelKey: "params.displayTimeRelative",
					id: 27,
					parent: 6,
				},
				dyslexicFont: {
	...
	actions: {
		populateData() {
			...
			for (const cat in this.$state) {
				...
				for (const key in props) {
					...
					if (
						...
						const pointer = (stateValue as Record<string, any>)[
							k
						] as TwitchatDataTypes.ParameterData<unknown>; // Lazy typing...
						if (typeof pointer.value === "boolean") {
							pointer.value = v == "true";
						} else if (typeof pointer.value === "string") {
							pointer.value = v;
						} else if (typeof pointer.value === "number") {
			...
			if (goXLRParams) {
				...
				if (ip && port && this.goxlrConfig.enabled) {
					GoXLRSocket.instance.connect(ip, port).catch((_error) => {});
				}
			}
		...
		addChatColumn(
			after?: TwitchatDataTypes.ChatColumnsConfig,
		): TwitchatDataTypes.ChatColumnsConfig {
			let order = 0;
		...
		delChatColumn(column: TwitchatDataTypes.ChatColumnsConfig): void {
			...
			for (let i = 0; i < this.chatColumnsConfig.length; i++) {
				...
				if (e == column) {
					...
					decrement = true;
					i--;
				} else if (decrement) e.order--;
			}
			//Move "greet them" and "panels" to the last col if they were enabled
			//on the deleted col
			if (column.showPanelsHere)
				this.chatColumnsConfig[this.chatColumnsConfig.length - 1]!.showPanelsHere = true;
			if (column.showGreetHere)
		...
		searchParam(search: string): void {
			this.currentParamSearch = search;
		},
		...
		setGoXLREnabled(enabled: boolean): void {
			...
			if (enabled === true) {
				...
				GoXLRSocket.instance
					.connect(this.goxlrConfig.ip, this.goxlrConfig.port)
					.catch((_error) => {});
			} else {
