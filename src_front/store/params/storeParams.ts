...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		features: {
			...
			saveHistory: 				{save:true, type:"boolean", value:true, labelKey:"params.saveHistory", id:224, icon:"history", storage:{vnew:{date:1690765812999, id:'params_chathistory'}}},
			mergeConsecutive:	 		{save:true, type:"boolean", value:true, labelKey:"params.mergeConsecutive", id:225, icon:"merge", storage:{vnew:{date:1690765812999, id:'params_chatmerge'}}},
		...
		appearance: {
			...
			highlightusernames: 		{save:true, type:"boolean", value:true, labelKey:"params.highlightusernames", id:44, icon:"user", example:"clickable_mentions.png", storage:{vnew:{date:1690765812999, id:'params_chathighlightmentions'}}},
			...
			recentAccountUserBadge: 	{save:true, type:"boolean", value:false, labelKey:"params.recentAccountUserBadge", id:46, icon:"date", example:"recent_account.png", storage:{vnew:{date:1690765812999, id:'params_chatrecentbadge'}}},
			...
			showRaidStreamInfo: 		{save:true, type:"boolean", value:true, labelKey:"params.showRaidStreamInfo", id:43, icon:"raid", example:"raid_infos.png", storage:{vnew:{date:1690765812999, id:'params_chatraidinfo'}}},
