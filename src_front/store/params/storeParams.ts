...
export const storeParams = defineStore('params', {
	state: () => ({
		...
		appearance: {
			...
			showRaidStreamInfo: 		{save:true, type:"boolean", value:true, labelKey:"params.showRaidStreamInfo", id:43, icon:"raid", storage:{vnew:{date:1690765812999, id:'params_chatraidinfo'}}},
