	...
	actions: {
		...
		createCustomTrain():void {
			this.customTrainList.push({
				...
				approachingEmote:"",
				failedLabel:StoreProxy.i18n.t("overlay.customTrain.param_failedLabel"),
				failedEmote:"",
				successLabel:StoreProxy.i18n.t("overlay.customTrain.param_successLabel"),
				successEmote:"",
				cooldownDuration_ms:2*3600*1000,
				levelsDuration_ms:5*60*1000,
				platforms:TwitchatDataTypes.CustomTrainData_Platforms.concat(),
				postLevelUpMessage:false,
