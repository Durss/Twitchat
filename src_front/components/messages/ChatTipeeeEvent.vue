<template>
	<div
		class="chattipeeevent chatMessage highlight"
		...
		<div class="messageHolder">
			...
			<div
				...
				v-if="
					...
					(messageData.eventType == 'merch' && messageData.message)
				"
			>
...
class ChatTipeeeEvent extends AbstractChatMessage {
	...
	public get labelKey(): string {
		if (this.messageData.recurring && this.messageData.recurringCount > 1)
			return "chat.tipeee.donation_recurring";
