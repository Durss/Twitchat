	...
	<div class="chatad chatMessage">
		<div class="innerHolder">
			...
			<div v-else-if="isUpdate" class="card-item primary updates">
				<div class="header">
					<CloseButton :aria-label="$t('changelog.closeBt_aria')" @click.stop="deleteMessage()" theme="light" />
			...
			<div v-if="isTip" class="card-item primary tip">
				<div class="header">
					<CloseButton :aria-label="$t('chat.closeBt_aria')" @click.stop="deleteMessage()" theme="light" />
			...
			<div v-if="isAdWarning" class="card-item primary">
				<div class="header">
					<CloseButton :aria-label="$t('chat.closeBt_aria')" @click.stop="confirmGngngnClose()" theme="light" />
