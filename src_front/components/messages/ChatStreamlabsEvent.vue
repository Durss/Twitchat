<template>
	<div
		class="chatstreamlabsevent chatMessage highlight"
		...
		<div class="messageHolder">
			<i18n-t scope="global" tag="span" :keypath="labelKey">
				...
				<template
					#AMOUNT
					v-if="
						messageData.eventType == 'donation' ||
						messageData.eventType == 'patreon_pledge' ||
						messageData.eventType == 'charity'
					"
				>
...
class ChatStreamlabsEvent extends AbstractChatMessage {
	...
	public get labelKey(): string {
		switch (this.messageData.eventType) {
			case "merch":
				return "chat.streamlabs.merch";
			case "donation":
				return "chat.streamlabs.donation";
			case "patreon_pledge":
				return "chat.streamlabs.patreon_pledge";
			case "charity":
				return "chat.streamlabs.charity";
		}
		return "";
	}
}
