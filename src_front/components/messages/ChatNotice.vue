...
class ChatNotice extends AbstractChatMessage {
	...
	public get classes(): string[] {
		...
		if (this.messageData.noticeId == TwitchatDataTypes.TwitchatNoticeType.COMMERCIAL_ERROR)
			res.push("alert");
		...
		if (
			this.messageData.noticeId == TwitchatDataTypes.TwitchatNoticeType.SUB_ONLY_OFF ||
		...
		if (
			this.messageData.noticeId == TwitchatDataTypes.TwitchatNoticeType.SUB_ONLY_ON ||
