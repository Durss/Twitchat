		...
		<div class="content">
			...
			>
				<template #USER>
					<a
						class="userlink"
						@click.stop="openUserCard(messageData.creator!, messageData.channel_id)"
						>{{ messageData.creator.displayName }}</a
					>
				</template>
			</i18n-t>
			...
			<div class="choices">
				<div
					v-for="o in messageData.outcomes"
					:key="o.id"
					class="choice"
					:class="getOutcomeClasses(o)"
				>
					<div class="infos">
...
class ChatPredictionResult extends AbstractChatMessage {
	...
	public getOutcomeStyles(o: TwitchatDataTypes.MessagePredictionDataOutcome): {
		[key: string]: string;
	} {
