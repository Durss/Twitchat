<template>
	<div class="overlayparamsulule overlayParamsSection">
		<i18n-t class="header" scope="global" tag="div" keypath="overlay.ulule.description">
			<template #LINK>
				<a href="https://ulule.com" target="_blank">{{
					$t("overlay.ulule.description_link")
				}}</a>
			</template>
		</i18n-t>
...
class OverlayParamsUlule extends Vue {
	public param_project: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 200,
		labelKey: "overlay.ulule.project_name",
		placeholder: "https://ulule.com/your-project...",
	};
	public param_goals: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 200,
		labelKey: "overlay.ulule.project_goals",
		placeholder: "10000,25000,50000,100000,...",
		tooltipKey: "overlay.ulule.project_goals_tt",
	};
	public param_title: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 100,
		labelKey: "overlay.ulule.project_title",
	};
	public param_currency: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "$",
		maxLength: 5,
		labelKey: "overlay.ulule.project_currency",
	};
	...
	public get overlayUrl(): string {
		...
		let url = Utils.overlayURL("ulule", [
			...
			{ k: "title", v: this.param_title.value },
		]);
		return url;
	}
	...
	public saveConfigs(): void {
		...
		if (this.param_project.value)
			DataStore.set(DataStore.ULULE_PROJECT, this.param_project.value);
		...
		if (this.param_currency.value)
			DataStore.set(DataStore.ULULE_CURRENCY, this.param_currency.value);
