...
class OverlayParamsPredictions extends Vue {
	...
	public param_showVoters: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		icon: "user",
	...
	public param_hideUntilResolved: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: true,
		icon: "hide",
	...
	public async testOverlay(): Promise<void> {
		...
		const predi: TwitchatDataTypes.MessagePredictionData =
			await this.$store.debug.simulateMessage<TwitchatDataTypes.MessagePredictionData>(
