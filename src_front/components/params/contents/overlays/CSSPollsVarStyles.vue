<template>
  ...
  <span class="comment">/* Values text color (votes, percents, ...) */</span>
  --value-text: #000000;
  <span class="comment">/* Values background (votes, percents, ...) */</span>
  --value-bg: rgba(0, 0, 0, .5);
  <span class="comment">/* Background window color */</span>
