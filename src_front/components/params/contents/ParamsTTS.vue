...
export default class ParamsTTS extends Vue implements IParameterContent {
	...
	public param_removeEmotes:TwitchatDataTypes.ParameterData = {type:"boolean", value:true, label:""};

	public param_maxLengthToggle:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"" };
	public param_maxLength:TwitchatDataTypes.ParameterData = {type:"slider", value:200, label:"", min:10, max:500, step:10};
	public param_maxDurationToggle:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"" };
	public param_maxDuration:TwitchatDataTypes.ParameterData = {type:"slider", value:30, label:"", min:0, max:60, step:1};
	public param_timeoutToggle:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"" };
	public param_timeout:TwitchatDataTypes.ParameterData = {type:"slider", value:60, label:"", min:0, max:30, step:1};
	public param_inactivityPeriodToggle:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"" };
	public param_inactivityPeriod:TwitchatDataTypes.ParameterData = {type:"slider", value:0, label:"", min:0, max:60, step:1};
	public param_removeURL:TwitchatDataTypes.ParameterData = {type:"boolean", value:true, label:""};
	public param_replaceURL:TwitchatDataTypes.ParameterData = {type:"string", value:'link', label:""};

	public param_readMessages:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"user_purple.svg" };
	public param_readMessagesPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderMessages, maxLength:300};
	public param_readWhispers:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"whispers_purple.svg" };
	public param_readWhispersPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderMessages, maxLength:300};
	public param_readNotices:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"info_purple.svg" };
	public param_readNoticesPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderNotices, maxLength:300};
	public param_readTimeouts:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"timeout_purple.svg" };
	public param_readTimeoutsPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderTimeouts, maxLength:300};
	public param_readBans:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"ban_purple.svg" };
	public param_readBansPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderBans, maxLength:300};
	public param_readUnbans:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"unban_purple.svg" };
	public param_readUnbansPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderUnbans, maxLength:300};
	public param_readRewards:TwitchatDataTypes.ParameterData = {type:"boolean", value:true, label:"", icon:"channelPoints_purple.svg"};
	public param_readRewardsPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderRewards, maxLength:300};
	public param_readSubs:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"sub_purple.svg" };
	public param_readSubsPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderSubs, maxLength:300};
	public param_readSubgifts:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"gift_purple.svg" };
	public param_readSubgiftsPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderSubgifts, maxLength:300};
	public param_readBits:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"bits_purple.svg" };
	...
	public param_readBitsPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderBits, maxLength:300};
	public param_readRaids:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"raid_purple.svg" };
	public param_readRaidsPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderRaids, maxLength:300};
	public param_readFollow:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"follow_purple.svg" };
	public param_readFollowPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderFollows, maxLength:300};
	public param_readPolls:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"poll_purple.svg" };
	public param_readPollsPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderPolls, maxLength:300};
	public param_readPredictions:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"prediction_purple.svg" };
	public param_readPredictionsPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderPredictions, maxLength:300};
	public param_readBingos:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"bingo_purple.svg" };
	public param_readBingosPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderBingo, maxLength:300};
	public param_readRaffle:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"ticket_purple.svg" };
	public param_readRafflePattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderRaffles, maxLength:300};
	public param_read1stMessageToday:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"firstTime_purple.svg" };
	public param_read1stMessageTodayPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholder1stMessageToday, maxLength:300};
	public param_read1stTimeChatters:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"firstTime_purple.svg" };
	public param_read1stTimeChattersPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholder1stTimeChatters, maxLength:300};
	public param_readAutomod:TwitchatDataTypes.ParameterData = {type:"boolean", value:false, label:"", icon:"automod_purple.svg" };
	public param_readAutomodPattern:TwitchatDataTypes.ParameterData = {type:"string", value:"", label:"", placeholderList:TTSUtils.placeholderAutomod, maxLength:300};
