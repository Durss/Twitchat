		...
		<div class="fadeHolder" :style="holderStyles">
			...
			<section>
				...
				<ParamItem
					...
					v-newflag="{ date: $config.NEW_FLAGS_DATE_V16, id: 'tts_chatpolls' }"
				/>
				<ParamItem
...
class ParamsTTS  extends Vue implements IParameterContent {
	...
	public param_allRemoteChans: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: true,
		icon: "user",
	};
	public param_removeEmotes: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: true,
		icon: "emote",
	};
	public param_maxLengthToggle: TwitchatDataTypes.ParameterData<boolean, unknown, any> = {
		type: "boolean",
		value: false,
	};
	public param_maxLength: TwitchatDataTypes.ParameterData<number> = {
		type: "slider",
		value: 200,
		min: 10,
		max: 500,
	...
	public param_maxDurationToggle: TwitchatDataTypes.ParameterData<boolean, unknown, any> = {
		type: "boolean",
		value: false,
		icon: "timer",
	};
	...
	public param_timeoutToggle: TwitchatDataTypes.ParameterData<boolean, unknown, any> = {
		type: "boolean",
		value: false,
	};
	public param_timeout: TwitchatDataTypes.ParameterData<number> = {
		type: "slider",
		value: 60,
		min: 0,
		max: 30,
	...
	public param_inactivityPeriodToggle: TwitchatDataTypes.ParameterData<boolean, unknown, any> = {
		type: "boolean",
		value: false,
	};
	public param_inactivityPeriod: TwitchatDataTypes.ParameterData<number> = {
		type: "slider",
		value: 0,
		min: 0,
		max: 60,
	...
	public param_removeURL: TwitchatDataTypes.ParameterData<boolean, unknown, any> = {
		type: "boolean",
		value: true,
		icon: "url",
	};
	public param_replaceURL: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "link",
	};

	public param_readMessages: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "user",
	};
	public param_readMessagesPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readWhispers: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "whispers",
	};
	public param_readWhispersPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
		placeholderList: TTSUtils.placeholderMessages,
	...
	public param_readNotices: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "info",
	};
	public param_readNoticesPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readTimeouts: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "timeout",
	};
	public param_readTimeoutsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readBans: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "ban",
	};
	public param_readBansPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readUnbans: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "unban",
	};
	public param_readUnbansPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readRewards: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: true,
		icon: "channelPoints",
	};
	public param_readRewardsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readSubs: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "sub",
	};
	public param_readSubsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readSubgifts: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "gift",
	};
	public param_readSubgiftsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readBits: TwitchatDataTypes.ParameterData<boolean, unknown, any> = {
		type: "boolean",
		value: false,
		icon: "bits",
	};
	public param_readBitsMinAmount: TwitchatDataTypes.ParameterData<number> = {
		type: "number",
		value: 0,
	...
	public param_readBitsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readRaids: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "raid",
	};
	public param_readRaidsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readFollow: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "follow",
	};
	public param_readFollowPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readPolls: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "poll",
	};
	public param_readPollsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readChatPolls: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "chatPoll",
	};
	public param_readChatPollsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readPredictions: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "prediction",
	};
	public param_readPredictionsPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readBingos: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "bingo",
	};
	public param_readBingosPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readRaffle: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "ticket",
	};
	public param_readRafflePattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_read1stMessageToday: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "firstTime",
	};
	public param_read1stMessageTodayPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_read1stTimeChatters: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "firstTime",
	};
	public param_read1stTimeChattersPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readAutomod: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "automod",
	};
	public param_readAutomodPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readMonitored: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "shield",
	};
	public param_readMonitoredPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
		placeholderList: TTSUtils.placeholderAutomod,
	...
	public param_readRestricted: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "shield",
	};
	public param_readRestrictedPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
		placeholderList: TTSUtils.placeholderAutomod,
	...
	public param_readKofiTip: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "kofi",
	};
	public param_readKofiTipPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readKofiMerch: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "kofi",
	};
	public param_readKofiMerchPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readKofiSub: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "kofi",
	};
	public param_readKofiSubPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readStreamlabsTip: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "streamlabs",
	};
	public param_readStreamlabsTipPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readStreamlabsMerch: TwitchatDataTypes.ParameterData<boolean, unknown, string> = {
		type: "boolean",
		value: false,
		icon: "streamlabs",
	};
	public param_readStreamlabsMerchPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readStreamlabsPatreon: TwitchatDataTypes.ParameterData<boolean, unknown, string> =
		{ type: "boolean", value: false, icon: "streamlabs" };
	public param_readStreamlabsPatreonPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_readStreamelementsTip: TwitchatDataTypes.ParameterData<boolean, unknown, string> =
		{ type: "boolean", value: false, icon: "streamelements" };
	public param_readStreamelementsTipPattern: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
	...
	public param_ttsPerms: TwitchatDataTypes.PermissionsData = Utils.getDefaultPermissions(
		true,
		true,
		false,
		true,
	...
	public get finalData(): TwitchatDataTypes.TTSParamsData {
		return {
			...
			voice: {
				...
				platform:
					this.$store.elevenLabs.voiceList?.findIndex(
						(x) => x.voice_id === this.voiceParams.voice,
					) > -1
						? "elevenlabs"
						: "system",
			},
			...
			maxDuration:
				this.param_maxDurationToggle.value === true ? this.param_maxDuration.value : 0,
			timeout: this.param_timeoutToggle.value === true ? this.param_timeout.value : 0,
			inactivityPeriod:
				this.param_inactivityPeriodToggle.value === true
					? this.param_inactivityPeriod.value
					: 0,
	...
	public async beforeMount(): Promise<void> {
		...
		this.param_readStreamlabsTipPattern.labelKey =
			"tts.messages.param_readStreamlabsTipPattern";
		...
		this.param_readStreamelementsTipPattern.labelKey =
		...
		this.param_readMessagesPattern.value = label(
			params.readMessagePatern,
			this.$t("tts.patterns.readMessagePatern"),
		);
		this.param_readWhispers.value = params.readWhispers === true;
		this.param_readWhispersPattern.value = label(
			params.readWhispersPattern,
			this.$t("tts.patterns.readWhispersPattern"),
		);
		this.param_readNotices.value = params.readNotices === true;
		this.param_readNoticesPattern.value = label(
			params.readNoticesPattern,
			this.$t("tts.patterns.readNoticesPattern"),
		);
		this.param_readRewards.value = params.readRewards === true;
		this.param_readRewardsPattern.value = label(
			params.readRewardsPattern,
			this.$t("tts.patterns.readRewardsPattern"),
		);
		this.param_readSubs.value = params.readSubs === true;
		this.param_readSubsPattern.value = label(
			params.readSubsPattern,
			this.$t("tts.patterns.readSubsPattern"),
		);
		this.param_readSubgifts.value = params.readSubgifts === true;
		this.param_readSubgiftsPattern.value = label(
			params.readSubgiftsPattern,
			this.$t("tts.patterns.readSubgiftsPattern"),
		);
		this.param_readBits.value = params.readBits === true;
		this.param_readBitsMinAmount.value = params.readBitsMinAmount;
		this.param_readBitsPattern.value = label(
			params.readBitsPattern,
			this.$t("tts.patterns.readBitsPattern"),
		);
		this.param_readRaids.value = params.readRaids === true;
		this.param_readRaidsPattern.value = label(
			params.readRaidsPattern,
			this.$t("tts.patterns.readRaidsPattern"),
		);
		this.param_readFollow.value = params.readFollow === true;
		this.param_readFollowPattern.value = label(
			params.readFollowPattern,
			this.$t("tts.patterns.readFollowPattern"),
		);
		this.param_readPolls.value = params.readPolls === true;
		this.param_readPollsPattern.value = label(
			params.readPollsPattern,
			this.$t("tts.patterns.readPollsPattern"),
		);
		this.param_readChatPolls.value = params.readChatPolls === true;
		this.param_readChatPollsPattern.value = label(
			params.readChatPollsPattern,
			this.$t("tts.patterns.readChatPollsPattern"),
		);
		this.param_readBingos.value = params.readBingos === true;
		this.param_readBingosPattern.value = label(
			params.readBingosPattern,
			this.$t("tts.patterns.readBingosPattern"),
		);
		this.param_readRaffle.value = params.readRaffle === true;
		this.param_readRafflePattern.value = label(
			params.readRafflePattern,
			this.$t("tts.patterns.readRafflePattern"),
		);
		this.param_readPredictions.value = params.readPredictions === true;
		this.param_readPredictionsPattern.value = label(
			params.readPredictionsPattern,
			this.$t("tts.patterns.readPredictionsPattern"),
		);
		this.param_read1stMessageToday.value = params.read1stMessageToday === true;
		this.param_read1stMessageTodayPattern.value = label(
			params.read1stMessageTodayPattern,
			this.$t("tts.patterns.read1stMessageTodayPattern"),
		);
		this.param_read1stTimeChatters.value = params.read1stTimeChatters === true;
		this.param_read1stTimeChattersPattern.value = label(
			params.read1stTimeChattersPattern,
			this.$t("tts.patterns.read1stTimeChattersPattern"),
		);
		this.param_readMonitored.value = params.readMonitored === true;
		this.param_readMonitoredPattern.value = label(
			params.readMonitoredPattern,
			this.$t("tts.patterns.readMonitoredPattern"),
		);
		this.param_readRestricted.value = params.readRestricted === true;
		this.param_readRestrictedPattern.value = label(
			params.readRestrictedPattern,
			this.$t("tts.patterns.readRestrictedPattern"),
		);
		this.param_readAutomod.value = params.readAutomod === true;
		this.param_readAutomodPattern.value = label(
			params.readAutomodPattern,
			this.$t("tts.patterns.readAutomodPattern"),
		);
		this.param_readTimeouts.value = params.readTimeouts === true;
		this.param_readTimeoutsPattern.value = label(
			params.readTimeoutsPattern,
			this.$t("tts.patterns.readTimeoutsPattern"),
		);
		this.param_readBans.value = params.readBans === true;
		this.param_readBansPattern.value = label(
			params.readBansPattern,
			this.$t("tts.patterns.readBansPattern"),
		);
		this.param_readUnbans.value = params.readUnbans === true;
		this.param_readUnbansPattern.value = label(
			params.readUnbansPattern,
			this.$t("tts.patterns.readUnbansPattern"),
		);

		this.param_readKofiTip.value = params.readKofiTip === true;
		this.param_readKofiTipPattern.value = label(
			params.readKofiTipPattern,
			this.$t("tts.patterns.readKofiTipPattern"),
		);
		this.param_readKofiMerch.value = params.readKofiMerch === true;
		this.param_readKofiMerchPattern.value = label(
			params.readKofiMerchPattern,
			this.$t("tts.patterns.readKofiMerchPattern"),
		);
		this.param_readKofiSub.value = params.readKofiSub === true;
		this.param_readKofiSubPattern.value = label(
			params.readKofiSubPattern,
			this.$t("tts.patterns.readKofiSubPattern"),
		);
		this.param_readStreamlabsTip.value = params.readStreamlabsTip === true;
		this.param_readStreamlabsTipPattern.value = label(
			params.readStreamlabsTipPattern,
			this.$t("tts.patterns.readStreamlabsTipPattern"),
		);
		this.param_readStreamlabsMerch.value = params.readStreamlabsMerch === true;
		this.param_readStreamlabsMerchPattern.value = label(
			params.readStreamlabsMerchPattern,
			this.$t("tts.patterns.readStreamlabsMerchPattern"),
		);
		this.param_readStreamlabsPatreon.value = params.readStreamlabsPatreon === true;
		this.param_readStreamlabsPatreonPattern.value = label(
			params.readStreamlabsPatreonPattern,
			this.$t("tts.patterns.readStreamlabsPatreonPattern"),
		);
		this.param_readStreamelementsTip.value = params.readStreamelementsTip === true;
		this.param_readStreamelementsTipPattern.value = label(
			params.readStreamelementsTipPattern,
			this.$t("tts.patterns.readStreamelementsTipPattern"),
		);
