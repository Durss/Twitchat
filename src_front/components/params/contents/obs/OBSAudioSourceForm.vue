...
class OBSAudioSourceForm extends Vue {
	...
	public obsAllowed_audioSources: TwitchatDataTypes.ParameterData<string> = {
		type: "list",
		value: "",
		listValues: [],
	};
	public obsAllowed_muteCommand: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		placeholder: "!mute",
	};
	public obsAllowed_unmuteCommand: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		placeholder: "!unmute",
	};
	...
	public onAudioParamChange(): void {
		if (
			!this.obsAllowed_audioSources.value ||
			(this.obsAllowed_unmuteCommand.value === "" && this.obsAllowed_muteCommand.value === "")
		)
			return;
