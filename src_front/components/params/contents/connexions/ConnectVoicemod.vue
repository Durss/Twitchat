<template>
	<ConnectionForm
		class="paramsvoicemod"
		icon="voicemod"
		:connected="connected"
		:connecting="connecting"
		:error="error"
		:showSuccess="showSuccess"
		errorMessage="voicemod.connect_failed"
		:canConnect="canConnect"
		:connectedInfo="connectedInfo"
		:enabled="param_enabled.value"
		@connect="doConnect"
...
const connectedInfo = computed(() => [
	{ label: param_ip.value.label ?? "IP", value: param_ip.value.value },
...
function onToggleEnabled(value: boolean): void {
	param_enabled.value.value = value;
	saveData();
}
