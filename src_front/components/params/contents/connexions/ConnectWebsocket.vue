<template>
	<div class="connectwebsocket parameterContent">
		...
		<div class="content">
			...
			<div class="card-item alert" v-if="error" @click="error = false">
...
class ConnectWebsocket extends Vue {
	...
	public param_secured: TwitchatDataTypes.ParameterData<boolean> = {
		value: false,
		type: "boolean",
	...
	public connect(): void {
		...
		WebsocketTrigger.instance
			.connect(this.param_ip.value, this.param_port.value, this.param_secured.value)
			.then(() => {
