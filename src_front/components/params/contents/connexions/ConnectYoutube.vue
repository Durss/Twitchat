<template>
	<div class="connectyoutube parameterContent">
		...
		<TTButton
			class="premiumBt"
			icon="premium"
			@click="$store.params.openParamsPage('premium')"
			big
			v-if="!$store.auth.isPremium"
			premium
...
class ConnectYoutube extends Vue {
	...
	public param_scope_read: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		icon: "whispers",
		value: true,
	...
	public param_scope_moderate: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		icon: "mod",
		value: false,
