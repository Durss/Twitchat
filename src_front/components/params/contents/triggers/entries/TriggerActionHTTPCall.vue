...
export default class TriggerActionHTTPCall extends AbstractTriggerActionEntry {
	...
	public beforeMount():void {
		if(this.action.sendAsBody === undefined) {
			this.action.sendAsBody = this.param_sendAsBody.value;
		}
		if(this.action.customHeaders === undefined) {
			this.action.customHeaders = this.param_customHeaders.value;
		}
