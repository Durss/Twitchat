<template>
	<div class="triggeractionjsonextract triggerActionForm">
		<ParamItem
			:paramData="param_sourcePlaceholder"
			v-model="action.jsonExtractData.sourcePlaceholder"
		/>

		<TriggerActionHttpPlaceholder
			:placeholderList="action.jsonExtractData.outputPlaceholderList"
		/>
	</div>
</template>
...
class TriggerActionJSONExtract extends AbstractTriggerActionEntry {
	...
	public param_sourcePlaceholder: TwitchatDataTypes.ParameterData<string> = {
		type: "list",
		value: "",
		listValues: [],
		labelKey: "triggers.actions.json_extract.source_placeholder",
	};
	...
	public beforeMount(): void {
		...
		if (!this.action.jsonExtractData.outputPlaceholderList)
			this.action.jsonExtractData.outputPlaceholderList = [];
	}
