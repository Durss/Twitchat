<template>
	<div class="triggeractionlumiaentry triggerActionForm">
		...
		<ParamItem
			:paramData="param_transition"
			v-model="action.lumia.colorTransition_s"
		></ParamItem>
...
class TriggerActionLumiaEntry extends AbstractTriggerActionEntry {
	public param_color: TwitchatDataTypes.ParameterData<number> = {
		type: "color",
		value: 0,
		labelKey: "triggers.actions.lumia.param_color",
		icon: "color",
	};
	public param_brightness: TwitchatDataTypes.ParameterData<number> = {
		type: "slider",
		value: 100,
		min: 0,
		max: 100,
		allowMs: true,
		labelKey: "triggers.actions.lumia.param_brightness",
		icon: "brightness",
	};
	public param_duration: TwitchatDataTypes.ParameterData<number> = {
		...
		value: 0,
		allowMs: true,
		labelKey: "triggers.actions.lumia.param_duration",
		icon: "timer",
	};
	public param_transition: TwitchatDataTypes.ParameterData<number> = {
		type: "duration",
		value: 0,
		allowMs: true,
		labelKey: "triggers.actions.lumia.param_transition",
		icon: "timer",
	};
