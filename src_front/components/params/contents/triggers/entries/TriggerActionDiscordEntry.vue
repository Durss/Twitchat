...
class TriggerActionDiscordEntry extends AbstractTriggerActionEntry {
	...
	public param_message: TwitchatDataTypes.ParameterData<string> = {
		...
		icon: "whispers",
		maxLength: 2000,
		labelKey: "triggers.actions.discord.param_message",
	};
	public param_channel: TwitchatDataTypes.ParameterData<string> = {
		type: "list",
		value: "",
		icon: "discord",
		labelKey: "triggers.actions.discord.param_channel",
	};
