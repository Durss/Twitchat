	...
	<div class="triggeractionobsentry triggerActionForm" v-if="!obsConnected">
		<div class="info warn">
			...
			<i18n-t scope="global" class="label" tag="p" keypath="triggers.actions.obs.header">
				<template #LINK>
					<a @click="$store.params.openParamsPage(contentConnexions, subcontentObs)">{{
		...
		<template v-else-if="action.obsAction === 'emitevent'">
			...
			<div class="info">
				...
				<div class="typescript">
					<pre><span class="keyword">window</span>.<span class="function">addEventListener</span>(<span class="string">"{{ action.browserEventName }}"</span>, (<span class="param">param</span>) => {
...
class TriggerActionOBSEntry extends AbstractTriggerActionEntry {
	...
	public param_obsAction_conf: TwitchatDataTypes.ParameterData<
		TriggerActionObsDataAction,
		TriggerActionObsDataAction
	> = {
		type: "list",
		value: "sources",
	...
	public param_sourceAction_conf: TwitchatDataTypes.ParameterData<
	...
	public param_source_conf: TwitchatDataTypes.ParameterData<string, string, string> = {
		type: "list",
		value: "",
		listValues: [],
		icon: "list",
	...
	public param_filter_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "list",
		value: "",
		listValues: [],
		labelKey: "triggers.actions.obs.param_filter",
	};
	public param_text_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		longText: true,
		value: "",
		icon: "whispers",
	...
	public param_url_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		icon: "url",
		maxLength: 10000,
	...
	public param_css_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
		maxLength: 10000,
	...
	public param_media_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		icon: "url",
		maxLength: 10000,
	...
	public param_mediaEndEvent_conf: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		icon: "countdown",
		labelKey: "triggers.actions.obs.param_mediaEvent",
	};
	public param_x_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		icon: "coord_x",
		maxLength: 500,
	...
	public param_y_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		icon: "coord_y",
		maxLength: 500,
	...
	public param_angle_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		icon: "number",
		maxLength: 500,
	...
	public param_width_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		icon: "number",
		maxLength: 500,
	...
	public param_height_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		icon: "number",
		maxLength: 500,
	...
	public param_transformRelative_conf: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		icon: "number",
	};
	public param_transformAnimate_conf: TwitchatDataTypes.ParameterData<boolean, unknown, any> = {
		type: "boolean",
		value: false,
		icon: "animate",
		labelKey: "triggers.actions.obs.param_transform_animate",
	};
	public param_transformEasing_conf: TwitchatDataTypes.ParameterData<
		TriggerActionObsData["animateEasing"]
	> = {
		type: "list",
		value: "linear.none",
		icon: "easing",
	...
	public param_transformDuration_conf: TwitchatDataTypes.ParameterData<number> = {
		type: "number",
		value: 500,
		min: 0,
		max: 60000,
	...
	public param_browserEvent_name: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 100,
		icon: "label",
	...
	public param_browserEvent_param: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 10000,
		longText: true,
	...
	public param_record_chapter_name: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 100,
		icon: "label",
	...
	public param_hotkeyAction_conf: TwitchatDataTypes.ParameterData<string, string> = {
		type: "list",
		value: "",
		icon: "press",
		labelKey: "triggers.actions.obs.param_record_hotkey_name",
	};
	public param_screenImgFormat_conf: TwitchatDataTypes.ParameterData<string, string> = {
		type: "list",
		value: "jpeg",
		icon: "screenshot",
		labelKey: "triggers.actions.obs.param_screenImgFormat_conf",
	};
	public param_screenImgSize_toggle_conf: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		icon: "scale",
		labelKey: "triggers.actions.obs.param_screenImgSize_toggle_conf",
	};
	public param_screenImgSize_width_conf: TwitchatDataTypes.ParameterData<number> = {
		type: "number",
		value: 1920,
		min: 8,
		max: 4096,
	...
	public param_screenImgSize_height_conf: TwitchatDataTypes.ParameterData<number> = {
		type: "number",
		value: 1080,
		min: 8,
		max: 4096,
	...
	public param_screenImgSavePath_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
	...
	public param_screenImgSavePH_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "placeholder",
		value: "",
		maxLength: 30,
	...
	public param_persistedKey_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 100,
		icon: "key",
	...
	public param_persistedValue_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 1000,
		icon: "font",
	...
	public param_persistedKeyPH_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "placeholder",
		value: "",
		maxLength: 30,
		allowedCharsRegex: "a-z0-9_",
	...
	public param_colorToggle_conf: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		icon: "color",
		labelKey: "triggers.actions.obs.param_colorToggle_conf",
	};
	public param_color_conf: TwitchatDataTypes.ParameterData<string> = {
		type: "color",
		value: "",
		labelKey: "triggers.actions.obs.param_color_conf",
	};
	public param_colorPlaceholder_conf: TwitchatDataTypes.ParameterData<string, string> = {
		type: "list",
		value: "",
		maxLength: 30,
		allowedCharsRegex: "a-z0-9_",
	...
	public param_colorAlpha_conf: TwitchatDataTypes.ParameterData<number> = {
		type: "slider",
		value: 100,
		min: 0,
		max: 100,
	...
	public get isTextSource(): boolean {
		const input = this.obsSources.find(
			(v) => "source_" + v.sourceName == this.param_source_conf.value,
		);
	...
	public get isBrowserSource(): boolean {
		return (
			this.obsSources.find((v) => "source_" + v.sourceName == this.param_source_conf.value)
	 ...
	 */
	public get canWaitForMediaEnd(): boolean {
		return (
			this.isMediaSource && (this.action.action == "show" || this.action.action == "replay")
		);
	}
	 ...
	 */
	public get canSetMediaPath(): boolean {
		return (
			this.isMediaSource &&
			this.param_filter_conf.value == "" &&
			this.param_sourceAction_conf.value == "show"
	 ...
	 */
	public get isInvalidScreenFilePath(): boolean {
		return !/[^\\/]+\.[^\\/]+$/.test(this.action.screenshotImgSavePath || "");
	}
	...
	public get isMediaSource(): boolean {
		let sourceName = this.param_source_conf.selectedListValue
			? (this.param_source_conf.selectedListValue as SourceItem).name
			: "";
		...
		if (inputKind === "image_source")
			this.param_media_conf.labelKey = "triggers.actions.obs.param_media_img";
		return (
	...
	public async beforeMount(): Promise<void> {
		...
		this.param_screenImgFormat_conf.listValues = (
	...
	public async mounted(): Promise<void> {
		...
		this.param_screenImgSavePath_conf.errorMessage = this.$t(
		...
		const easing = this.$tm("triggers.actions.obs.param_transform_animate_easing_list") as {
			[key: string]: string;
		};
		...
		watch(
			() => this.param_sourceAction_conf.value,
			() => this.cleanupData(),
		);
		watch(
			() => this.param_source_conf.value,
			...
			() => {
				if (this.param_source_conf.selectedListValue) {
					this.action.sourceName = (
						this.param_source_conf.selectedListValue as SourceItem
					).name;
				} else {
					this.action.sourceName = "";
				}
	...
	public onPlaceholderUpdate(list: ITriggerPlaceholder<any>[]): void {
		this.param_text_conf.placeholderList =
			...
			this.param_persistedValue_conf.placeholderList =
				list;
		this.param_colorPlaceholder_conf.listValues = list.map((v) => {
			return { label: this.$t(v.descKey, v.descReplacedValues ?? {}), value: v.tag };
		});
		...
		this.param_x_conf.placeholderList =
			...
			this.param_height_conf.placeholderList =
	...
	private async prefillForm(cleanData: boolean = true): Promise<void> {
		...
		list.push({
			...
			value: "scene_" + this.$t("triggers.actions.obs.param_source_currentScene"),
			type: "scene",
			name: this.$t("triggers.actions.obs.param_source_currentScene"),
		});
		//Add existing OBS scenes
		list = list.concat(
			this.obsScenes.map<SourceItem>((v) => {
				return {
					label: v.sceneName,
		...
		if (this.obsSources.length > 0) {
			...
			list = list.concat(
				this.obsSources.map<SourceItem>((v) => {
					return {
						label: v.sourceName,
	...
	private async onSourceChanged(
		...
		if (this.param_source_conf.value != "") {
			try {
				...
				this.filters = await OBSWebSocket.instance.getSourceFilters(
					this.param_source_conf.value.replace(/^[a-z]+_/gi, ""),
				);
			} catch (error) {
				this.filters = [];
			}
		...
		if (this.filters.length > 0 || this.action.filterName) {
			...
			if (
				forceFilterEntry &&
				this.action.filterName &&
				!list.find((v) => v.value == this.action.filterName)
			) {
	...
	private updateFilter(cleanData: boolean = true): void {
		if (
			this.param_source_conf.children &&
			this.param_source_conf.children?.length > 0 &&
			this.param_filter_conf.value != ""
		) {
	...
	private async cleanupData(): Promise<void> {
		...
		if (
			...
			if (this.action.action == "move") {
				this.param_transformRelative_conf.labelKey =
