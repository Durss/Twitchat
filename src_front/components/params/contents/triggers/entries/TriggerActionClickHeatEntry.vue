...
class TriggerActionClickHeatEntry extends AbstractTriggerActionEntry {
	...
	public param_overlay: TwitchatDataTypes.ParameterData<string> = {
		type: "list",
		value: "",
		labelKey: "triggers.actions.heat_click.param_overlay",
	};
	public param_forward: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: true,
		labelKey: "triggers.actions.heat_click.param_forward",
	};
	public param_x: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 500,
		labelKey: "triggers.actions.heat_click.param_x",
	};
	public param_y: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		maxLength: 500,
		labelKey: "triggers.actions.heat_click.param_y",
	};
	public param_ctrl: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		labelKey: "triggers.actions.heat_click.param_ctrl",
	};
	public param_shift: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		labelKey: "triggers.actions.heat_click.param_shift",
	};
	public param_alt: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
