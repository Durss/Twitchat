	...
	<div :class="classes">
		...
		<TransitionGroup name="overlayItem" tag="div" class="list" v-if="subContent == null">
			...
			<button
				class="item"
				key="wheel"
				v-if="matchesSearch('wheel')"
				@click="subContent = 'wheel'"
			>
			...
			<button
				class="item"
				key="music"
				v-if="matchesSearch('music')"
				@click="subContent = 'music'"
			>
			...
			<button
				class="item"
				key="chathighlight"
				v-if="matchesSearch('chathighlight')"
				@click="subContent = 'chathighlight'"
			>
				<img src="@/assets/img/overlays/highlights.jpg" alt="Chat highlight" />
			...
			<button
				class="item"
				key="counter"
				v-if="matchesSearch('counter')"
				@click="subContent = 'counter'"
			>
			...
			<button
				class="item"
				key="ulule"
				v-if="matchesSearch('ulule')"
				@click="subContent = 'ulule'"
			>
		...
		<div class="form">
			<OverlayParamsCredits
				class="block"
				:open="subContent == 'credits'"
				v-if="subContent == 'credits'"
			/>
			<OverlayParamsBitswall
				class="block"
				:open="subContent == 'bitswall'"
				v-if="subContent == 'bitswall'"
			/>
			<OverlayParamsHeatDistort
				class="block"
				:open="subContent == 'distort'"
				v-if="subContent == 'distort'"
			/>
			<OverlayParamsRaffle
				class="block"
				:open="subContent == 'wheel'"
				v-if="subContent == 'wheel'"
			/>
			<OverlayParamsHighlight
				class="block"
				:open="subContent == 'chathighlight'"
				v-if="subContent == 'chathighlight'"
			/>
			<OverlayParamsSpotify
				class="block"
				:open="subContent == 'music'"
				v-if="subContent == 'music'"
			/>
			<OverlayParamsTimer
				class="block"
				:open="subContent == 'timer'"
				v-if="subContent == 'timer'"
			/>
			<OverlayParamsCounter
				class="block"
				:open="subContent == 'counter'"
				v-if="subContent == 'counter'"
			/>
			<!-- <OverlayParamsTTS class="block"				:open="subContent == 'tts'"				v-if="subContent == 'tts'" /> -->
			<OverlayParamsAdBreak
				class="block"
				:open="subContent == 'adbreak'"
				v-if="subContent == 'adbreak'"
			/>
			<OverlayParamsUlule
				class="block"
				:open="subContent == 'ulule'"
				v-if="subContent == 'ulule'"
			/>
			<OverlayParamsPredictions
				class="block"
				:open="subContent == 'predictions'"
				v-if="subContent == 'predictions'"
			/>
			<OverlayParamsPolls
				class="block"
				:open="subContent == 'polls'"
				v-if="subContent == 'polls'"
			/>
			<OverlayParamsChatPoll
				class="block"
				:open="subContent == 'chatPoll'"
				v-if="subContent == 'chatPoll'"
			/>
			<OverlayParamsBingoGrid
				class="block"
				:open="subContent == 'bingogrid'"
				v-if="subContent == 'bingogrid'"
			/>
			<OverlayParamsLabels
				class="block"
			...
			<OverlayParamsDonationGoal
				class="block"
				:open="subContent == 'donationgoals'"
				v-if="subContent == 'donationgoals'"
			/>
			<OverlayParamsAnimatedText
				class="block"
				:open="subContent == 'animatedtext'"
				v-if="subContent == 'animatedtext'"
			/>
			<OverlayParamsCustomTrain
				class="block"
				:open="subContent == 'customtrain'"
				v-if="subContent == 'customtrain'"
			/>
			<OverlayParamsQuiz
				class="block"
