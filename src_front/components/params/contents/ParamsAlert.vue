<template>
	<div class="paramsalert parameterContent">
		...
		<section class="card-item">
			...
			<Button class="testBt" icon="test" @click="testAlert()">{{
				$t("alert.testBt")
			}}</Button>
		</section>
	</div>
...
class ParamsAlert extends Vue implements IParameterContent {
	...
	public param_message: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		labelKey: "alert.option_popin",
		value: true,
	};
	public param_shake: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		labelKey: "alert.option_shake",
		value: true,
	};
	public param_blink: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		labelKey: "alert.option_blink",
		value: false,
	};
	public param_sound: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		labelKey: "alert.option_sound",
		value: true,
	};
	public param_vibrate: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
	...
	public beforeMount(): void {
		let params: TwitchatDataTypes.AlertParamsData = JSON.parse(
			JSON.stringify(this.$store.main.chatAlertParams),
		);
		if (params) {
