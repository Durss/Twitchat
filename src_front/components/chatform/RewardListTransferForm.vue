	...
	<div class="rewardlisttransferform">
		<ul class="steps">
			<template v-for="(label, index) in $tm('rewards.manage.transfer_steps')">
				<li class="card-item" v-if="index < 3 || reward.image">
					...
					>
						...
						<template #REWARD
							><mark>{{ reward.title }}</mark></template
						>
						<template #RECREATE>
			...
			<li class="card-item icons" v-if="reward.image">
				<a
					v-if="reward.image?.url_1x"
					:href="reward.image.url_1x"
					target="_blank"
					:download="reward.title + '_28px.png'"
				...
				<a
					v-if="reward.image?.url_2x"
					:href="reward.image.url_2x"
					target="_blank"
					:download="reward.title + '_56px.png'"
					v-tooltip="$t('rewards.manage.download_icon_tt')"
				>
				...
				<a
					v-if="reward.image?.url_4x"
					:href="reward.image.url_4x"
					target="_blank"
					:download="reward.title + '_112px.png'"
					v-tooltip="$t('rewards.manage.download_icon_tt')"
				>
