...
class RewardListEditForm extends Vue {
	...
	public param_description: TwitchatDataTypes.ParameterData<string> = {
		type: "string",
		value: "",
		longText: true,
		maxLength: 200,
	...
	public param_prompt: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		labelKey: "rewards.manage.param_prompt",
		icon: "font",
	};
	public param_cost: TwitchatDataTypes.ParameterData<number | string> = {
		type: "number",
		value: 0,
		min: 1,
		max: 1000000000,
	...
	public param_paused: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
	...
	public param_skipQueue: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		labelKey: "rewards.manage.param_skipQueue",
		icon: "skip",
	};
	public param_cooldown: TwitchatDataTypes.ParameterData<boolean> = {
		type: "boolean",
		value: false,
		labelKey: "rewards.manage.param_cooldown",
		icon: "timeout",
	};
	public param_coolDown_duration: TwitchatDataTypes.ParameterData<number> = {
		type: "duration",
		value: 0,
		labelKey: "rewards.manage.param_coolDown_duration",
		icon: "timer",
	};
	public param_coolDown_maxPerStream: TwitchatDataTypes.ParameterData<number> = {
		type: "number",
		value: 0,
		min: 0,
		max: 1000000000,
	...
	public param_coolDown_maxPerUser: TwitchatDataTypes.ParameterData<number> = {
		type: "number",
		value: 0,
		min: 0,
		max: 1000000000,
	...
	public beforeMount(): void {
		...
		this.limitsEnabled =
			this.localValue.is_global_cooldown_enabled === true ||
	...
	public mounted(): void {
		...
		watch(
			() => this.reward,
			() => {
				this.importRewardData();
			},
		);
	}

	public onChange(): void {
		this.localValue.is_global_cooldown_enabled =
			this.limitsEnabled && (this.localValue.global_cooldown_seconds ?? 0) > 0;
		this.localValue.is_max_per_stream_enabled =
			this.limitsEnabled && (this.localValue.max_per_stream ?? 0) > 0;
		this.localValue.is_max_per_user_per_stream_enabled =
			this.limitsEnabled && (this.localValue.max_per_user_per_stream ?? 0) > 0;
	...
	private importRewardData(): void {
		...
		this.localValue.max_per_user_per_stream =
			this.reward.max_per_user_per_stream_setting.max_per_user_per_stream;
		this.localValue.is_global_cooldown_enabled = this.reward.global_cooldown_setting.is_enabled;
		this.localValue.global_cooldown_seconds =
			this.reward.global_cooldown_setting.global_cooldown_seconds;
		...
		this.localValue.should_redemptions_skip_request_queue =
			this.reward.should_redemptions_skip_request_queue;
	}
}
