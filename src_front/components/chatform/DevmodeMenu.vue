<template>
	<div class="devmodemenu">
		...
		<div class="list">
			...
			<Button small title="Ban" @click="simulateEvent('ban')" :icon="$image('icons/leave_white.svg')" />
			<Button small title="Unban" @click="simulateEvent('unban')" :icon="$image('icons/leave_white.svg')" />
