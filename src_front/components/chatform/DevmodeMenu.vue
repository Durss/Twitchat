<template>
	<div class="devmodemenu blured-background-window" ref="rootEl">
		...
		<div class="list" ref="list">
			...
			>
			<TTButton small @click="simulateEvent($event, 'user_modiversary')" icon="modiversary"
				>Modiversary</TTButton
			>
			...
			>
			<TTButton small @click="simulateEvent($event, 'message', 'gif')" icon="watchStreak"
				>GIF</TTButton
			>
