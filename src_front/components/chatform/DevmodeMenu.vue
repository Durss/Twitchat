<template>
	<div class="devmodemenu blured-background-window">
		...
		<div class="list">
			...
			<Button small @click="simulateEvent($event, 'twitchat_ad', 'ad_warn')" icon="whispers">Twitchat Ad
				warn</Button>
			<Button small @click="simulateEvent($event, 'twitchat_ad', 'donor_public_prompt')" icon="whispers">Donor
				prompt</Button>
			<Button small @click="simulateEvent($event, 'twitchat_ad', 'update_reminder')" icon="whispers">Update
				reminder</Button>
			<Button small @click="simulateEvent($event, 'twitchat_ad', 'ad_break_api')" icon="whispers">Ad break
				scopes</Button>
			...
			<Button small @click="simulateEvent($event, 'unban_request', 'unban_request_solve')"
				icon="unbanRequest">Unban Request solve</Button>
			...
			<Button small @click="simulateEvent($event, 'message', 'returning')" icon="returning">Returning
				user</Button>
			...
			<Button small @click="simulateEvent($event, 'gigantified_emote')" icon="watchStreak">Power Up Giant
				emote</Button>
			...
			<Button small @click="simulateEvent($event, 'raid', 'raidOffline')" icon="raid">Incoming raid
				offline</Button>
			...
			<Button small @click="simulateEvent($event, 'subscription', 'giftpaidupgrade')" icon="gift">Subgift
				upgrade</Button>
			...
			<Button small @click="simulateEvent($event, 'community_challenge_contribution')"
				icon="channelPoints">Challenge contribution</Button>
			...
			<Button small @click="simulateEvent($event, 'hype_train_cooled_down')" icon="train">Hype train
				cooldown</Button>
			...
			<Button small @click="simulateEvent($event, 'twitch_charity_donation')" icon="twitch_charity">Twitch charity
				donation</Button>
			<Button small @click="simulateEvent($event, 'streamelements', 'se_donation')"
				icon="streamelements">Streamelements donation</Button>
			<Button small @click="simulateEvent($event, 'streamlabs', 'sl_donation')" icon="streamlabs">Streamlabs
				donation</Button>
			<Button small @click="simulateEvent($event, 'streamlabs', 'sl_merch')" icon="streamlabs">Streamlabs
				merch</Button>
			<Button small @click="simulateEvent($event, 'streamlabs', 'sl_patreon')" icon="streamlabs">Streamlabs
				Patreon</Button>
			<Button small @click="simulateEvent($event, 'streamlabs', 'sl_charity')" icon="streamlabs">Streamlabs
				Charity</Button>
			<Button small @click="simulateEvent($event, 'streamlabs', 'sl_charity_spam')" icon="streamlabs">Streamlabs
				Ch. spam</Button>
			...
			<Button small @click="simulateEvent($event, 'shoutout', 'soReceived')" icon="shoutout">Receive
				shoutout</Button>
			...
			<Button small @click="simulateEvent($event, 'stream_online', 'my_stream_online')" icon="offline">My stream
				started</Button>
			<Button small @click="simulateEvent($event, 'stream_offline', 'my_stream_offline')" icon="offline">My stream
				stoped</Button>
			...
			<Button small secondary type="link" :href="pubsubHistoryLink" target="_blank" icon="download"
				v-if="pubsubHistoryLink">Download</Button>
