	...
	<div class="tabmenu">
		...
		>
			<TTButton
				...
				:small="small"
				:primary="
					(themes && themes.length > index && themes[index] == 'primary') || primary
				"
				:secondary="
					(themes && themes.length > index && themes[index] == 'secondary') || secondary
				"
				:alert="(themes && themes.length > index && themes[index] == 'alert') || alert"
				:premium="
					(themes && themes.length > index && themes[index] == 'premium') || premium
				"
