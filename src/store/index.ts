	...
	state: {
		...
		params: {
			...
			features: {
				...
				keepHighlightMyMessages:{ type:"toggle", value:false, label:"Reward \"highlight my message\" pushes messages to activity feed", id:210, icon:"notification_purple.svg"},
			} as {[key:string]:ParameterData}
