	...
	<div class="gngngn">
		...
		<div class="holder">
			...
			<div class="content">
				...
				<br>
				<p>Twitchat is made by a single person <i>(<a href="http://twitch.tv/durss" target="_blank">hello 👋</a>)</i>) and required at the very least 4-5 months of <strong>FULL TIME</strong> work to date.</p>
				<br>
				...
				<p><strong>We're not talking about advertising</strong> like on TV, Twitch or any other platform here. I'm not advertising for products or whatever that would generate constant revenues.</p>
				<p>I'm just sharing a link to Twitchat.</p>
				<br>
				<p><strong>Also, you can donate to remove it.</strong></p>
				...
				<p>Durss</p>
				<br>
				<ToggleBlock class="block" title="Why didn't you warned me before?" small :open="false">
					<p>I have.</p>
