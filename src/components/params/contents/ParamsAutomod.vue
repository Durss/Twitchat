...
export default class ParamsAutomod extends Vue {
	...
	public param_banUserNames:ParameterData = {type:"toggle", label:"Ban users whose names match a rule", value:false};
	...
	public param_keywordsEmergency:{[key:string]:ParameterData} = {};
	public param_keywordsOnlyFirst:{[key:string]:ParameterData} = {};
