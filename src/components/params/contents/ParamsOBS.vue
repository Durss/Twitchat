			...
			title="OBS credentials">
				...
				<transition name="fade">
					<div v-if="connectError" @click="connectError = false" class="error">
						<div>Unable to connect with OBS. Double check the port and password and make sure you have OBS 28 or that you installed <a :href="obswsInstaller" target="_blank">OBS-websocket plugin (v5)</a></div>
