	...
	******************/
	...
	public async simulateHypeTrain():Promise<void> {
		...
		for (let i = 0; i < PubsubJSON.HypetrainList.length; i+=2) {
			...
			console.log(Math.round((date.getTime() - dateOffset)/1000) + "s");
...
namespace PubsubJSON {
	...
	export const HypetrainList =[
		...
		{"type":"RESPONSE","error":"","nonce":"5K8QqDYvWJDt8Cwi8eCzmc9GOSRuz9"},
		new Date("Wed Aug 17 2022 21:15:45 GMT+0200"),
