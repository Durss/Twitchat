...
The hash received is the hash of what's written on the URL field of the browser source. If the protocol _(http(s)://)_ is missing, the hash will be computed without it which will differ from the one computed locally.\
