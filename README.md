...
If you still want to contribute before that, you might want to do it on the [refactor branch](https://github.com/Durss/Twitchat/tree/refactor) taht's getting close to a stable version.
<br>
<br>
<br>
